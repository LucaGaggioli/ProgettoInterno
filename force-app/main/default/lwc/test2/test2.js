...
//Icone per gli header delle card
const iconAccount = 'standard:account';
const iconOpportunity = 'standard:opportunity';
const iconLead = 'standard:lead';
